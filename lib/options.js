...
Options.prototype.beforeMultipart = function (provider, api, options) {}
Options.prototype.afterMultipart = function (provider, api, options) {}
...
Options.prototype.upload = function (provider, api, options) {
    ...
    this.beforeMultipart(provider, api, options);
    options.multipart = this.multipart(provider, api, options)
    this.afterMultipart(provider, api, options);
