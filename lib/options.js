...
Options.prototype.oauth = function (options) {
  ...
  options.oauth.consumer_key = options.oauth.consumer_key||this.provider.key
  options.oauth.consumer_secret = options.oauth.consumer_secret||this.provider.secret
  // options.oauth.token = options.oauth.token
  options.oauth.token_secret = options.oauth.secret||options.oauth.token_secret
  delete options.oauth.secret
