...
Config.prototype.config = function (name) {
    this.method = '';
    this.endpoint = '';
...
Config.prototype.get = function (endpoint) {
    this.method = 'get';
    this.endpoint = endpoint;
    return this;
}
Config.prototype.post = function (endpoint) {
    this.method = 'post';
    this.endpoint = endpoint;
    return this;
}
Config.prototype.put = function (endpoint) {
    this.method = 'put';
    this.endpoint = endpoint;
    return this;
}
Config.prototype.del = function (endpoint) {
    this.method = 'del';
    this.endpoint = endpoint;
    return this;
}
Config.prototype.request = function (callback) {
    return this.provider[this.method](this.endpoint, this.options, callback);
}

// options

Config.prototype.qs = function (options) {
    extend(true, this.options, {qs:options});
    return this;
}

Config.prototype.form = function (options) {
...
Config.prototype.upload = function (files) {
    extend(true, this.options, {upload:files});
    return this;
}

Config.prototype.multipart = function (files) {
    // not implemented
    return this;
}
