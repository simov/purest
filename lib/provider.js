...
Provider.prototype.createPath = function (endpoint, options) {
    ...
    switch (true) {
        ...
        case this.dropbox: case this.mailgun:
            return [version, endpoint].join('/');
        
        // api/v1/endpoint.json
        case this.stocktwits: case this.rubygems: case this.mandrill:
...
Provider.prototype.url = function (endpoint, options) {
    options = options||{};
    var name = options.api||this.api,
        domain = (this.apis && this.apis[name] && this.apis[name].domain) || this.domain;
    return [domain, this.createPath(endpoint, options)].join('/');
}
...
Provider.prototype.get = function (uri, options, callback) {
    ...
    return request(this.url(endpoint, options), options, utils.response(callback));
}
